                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach var="cartItem" items="${order.cart.cartItems}">
                                    <tr>
                                        ...
                                        <td class="col-md-" style="text-align: center">${cartItem.quantity}</td>
                                        <td class="col-md-" style="text-align: center">${cartItem.product.productPrice}</td>
                                        <td class="col-md-" style="text-align: center">${cartItem.totalPrice}</td>
                                    </tr>
                                </c:forEach>
