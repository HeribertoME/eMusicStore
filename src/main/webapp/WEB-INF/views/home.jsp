        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p>Her you can browse and buy Instruments, Records and related Accessories. Order now for
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Instrument" />"
               role="button">
                <img class="img-circle" src="<c:url value="/resources/images/instruments.jpg" />" alt="Instruments
        ...
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Record" />"
               role="button">
                <img class="img-circle" src="<c:url value="/resources/images/vinilo.png" />" alt="Instruments
                    Image" width="140" height="140">
            </a>

            <h2>Discography</h2>
            <p>An exceptional collection of music records in favor of the traditional and modern genre of jazz.</p>
        ...
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Accessory" />"
               role="button">
                <img class="img-circle" src="<c:url value="/resources/images/room.jpg" />" alt="Instruments
                    Image" width="140" height="140">
            </a>
            <h2>Accessories</h2>
